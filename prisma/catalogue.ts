  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        price: 1200,
        unit: "6 pieces",
        note: 'Supplied as "Hawawshi — Medium". Confirm whether a Large exists, in which case this becomes a size choice like Lasagna.',
      },
      {
        slug: "mini-hawawshi",
        name: "Mini Hawawshi",
        price: 500,
        unit: "20 pieces",
        note: "Added new. Allergens not yet tagged — nothing is named in the dish title.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        unit: "24 pieces",
        allergens: ["nuts"],
        note: "Added new. Allergens tagged from the name only and still need reviewing.",
      },
      {
      ...
      },
      {
        ...
        price: 800,
        unit: "Serves 5",
        note: "Added new. Allergens not tagged — nothing is named in the dish title, and this needs the same review as the rest.",
      },
      {
        slug: "creme-brulee",
        name: "Crème Brûlée",
      ...
      },
      {
        ...
        allergens: ["dairy"],
        note: "PRICE NOT UPDATED. One price (EGP 1,000) was supplied for a dish that sells as two priced flavours. Confirm whether both flavours become 1,000, or each has its own price.",
      },
      {
      ...
      },
      {
        ...
        price: 1150,
        unit: "30 pieces",
        note: 'PRICE NOT UPDATED, on instruction. EGP 90 for 30 pieces was supplied and is being confirmed; the rest of the range is EGP 900–1,250. Also confirm whether the name should become "Mini Baklava with Kunafa Drizzled with Caramel".',
      },
      {
